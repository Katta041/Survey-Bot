...
def benchmark_results_indic_whisper():
    results_path = os.path.join(config.AUDIO_DOWNLOAD_DIR, 'validation_results_indic_whisper.csv')
    ...
    print("\n--- Audio Validation Benchmark (Specialized Telugu Whisper) ---")
...
if __name__ == "__main__":
    benchmark_results_indic_whisper()
