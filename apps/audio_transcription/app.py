...
from src.core.telemetry import Span, log_llm_call, log_sarvam_call
...
if not openai_api_key or not sarvam_api_key:
    st.error("🔑 API Keys Missing! Please set them in `src/core/config.py` or as environment variables.")
    st.stop()
